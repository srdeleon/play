        ...
        return new JavaEssentialAction() {
            ...
            public Iteratee<byte[], SimpleResult> apply(RequestHeader rh) {
                ...
                if (!authorization.isEmpty()) {
                    ...
                    try {
                        String[] pass = new String(decoder.decodeBuffer(passanduser)).split(":");
                ...
                Tuple2<String, String> t = new Tuple2<String, String>("WWW-Authenticate",
                        "Basic realm=\"warehouse app\"");
                list.add(t);
                Seq<Tuple2<String, String>> seq = Scala.toSeq(list);
                return Done.apply(
                        unauthorized("Forbidden access to the warehouse app").getWrappedSimpleResult().withHeaders(seq),
                        null);
            }
        };
    }

    public abstract class JavaEssentialAction extends AbstractFunction1<RequestHeader, Iteratee<byte[], SimpleResult>>
